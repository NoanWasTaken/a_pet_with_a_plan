                    ...
                    <form action="{{ route('notes.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="note" id="note" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                <option value="1" {{ old('note') == '1' ? 'selected' : '' }}>1 étoile</option>
                                <option value="2" {{ old('note') == '2' ? 'selected' : '' }}>2 étoiles</option>
                                <option value="3" {{ old('note') == '3' ? 'selected' : '' }}>3 étoiles</option>
                                <option value="4" {{ old('note') == '4' ? 'selected' : '' }}>4 étoiles</option>
                                <option value="5" {{ old('note') == '5' ? 'selected' : '' }}>5 étoiles</option>
                            </select>
                            @error('note')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="commentaire" id="commentaire" rows="4" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required>{{ old('commentaire') }}</textarea>
                            @error('commentaire')
                                <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-center justify-end">
                            <a href="{{ route('notes.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">
                                Annuler
                            </a>
